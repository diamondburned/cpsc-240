...
msg_please_enter db "Please enter two float numbers separated by white space. Press enter after the second input.", 0xA, 0

msg_confirm_entered db "These numbers were entered:", 0xA, 0

msg_larger_number_f db "The larger number is %1.15lf", 0xA, 0

msg_ret_to_driver db "This assembly module will now return execution to the driver module.", 0xA, "The smaller number will be returned to the driver.", 0

msg_invalid_float db "An invalid input was detected. You may run this program again", 0xA, 0
